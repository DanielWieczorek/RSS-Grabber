...
@ApplicationScoped
public class RssSentimentNeuralNetworkPredictor extends AbstractNeuralNetworkPredictor<ClassifiedRssEntry, RssEntrySentiment> {

    @Inject
    private RssWord2VecNetwork vec;

    @Override
    protected INDArray buildPredictionFeatures(ClassifiedRssEntry item) {
    ...
    @Override
    protected RssEntrySentiment buildPredictionResult(ClassifiedRssEntry input, INDArray output) {
